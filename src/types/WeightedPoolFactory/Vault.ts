...
export class Vault extends ethereum.SmartContract {
  ...
  queryBatchSwap(
    ...
    let result = super.call(
      "queryBatchSwap",
      "queryBatchSwap(uint8,tuple[],address[],(address,bool,address,bool)):(int256[])",
      [
...
export class BatchSwapCall__Inputs {
  ...
  get funds(): BatchSwapCallFundsStruct {
    return this._call.inputValues[3].value.toTuple() as BatchSwapCallFundsStruct;
  }
...
export class ExitPoolCall__Inputs {
  ...
  get request(): ExitPoolCallRequestStruct {
    return this._call.inputValues[3].value.toTuple() as ExitPoolCallRequestStruct;
  }
}
...
export class JoinPoolCall__Inputs {
  ...
  get request(): JoinPoolCallRequestStruct {
    return this._call.inputValues[3].value.toTuple() as JoinPoolCallRequestStruct;
  }
}
